...
@endif
        ...
        <div class="card">
            <div class="card-body">
                <h2 class="mb-5">الطلاب</h2>
        
                <button class="btn btn-success" data-toggle="modal" data-target="#addAdminModal">إضافة طالب جديد</button>
            ...
            <div class="col-md-12">
                    ...
                    <tbody>
                        @foreach ($students as $student)
                            <tr>
                                ...
                                <td>{{ $student->class->name ?? 'غير متوفر' }}</td>
                                <td>
                                    <!-- زر تعديل -->
                                    <a href="#" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#editAdminModal{{ $student->id }}"><i class="fa fa-edit"></i></button></a>
                                    <!-- زر حذف -->
                            ...
                            <!-- نافذة تعديل الطالب -->
                            <div class="modal fade" id="editAdminModal{{ $student->id }}" tabindex="-1" role="dialog" aria-labelledby="editAdminModalLabel{{ $student->id }}" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="editAdminModalLabel{{ $student->id }}">تعديل بيانات الطالب</h5>
                                        ...
                                        <form action="{{ route('users.update', $student->id) }}" method="POST">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <select class="form-control" name="class_id" value="{{ $student->class_id }}">
                ...
                <div class="modal fade" id="addAdminModal" tabindex="-1" role="dialog" aria-labelledby="addAdminModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="addAdminModalLabel">إضافة طالب جديد</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
